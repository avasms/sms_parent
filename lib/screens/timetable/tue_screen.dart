...
class TuePage extends StatefulWidget{
@override
  _TuePageState createState() => new _TuePageState();
}

class _TuePageState extends State<TuePage>{
    @override
 void initState() {
    super.initState();
    _fetchData();
  ...
  _fetchData() async {
    ...
    final response =
        await http.get("http://192.168.100.4:8080/AVASMS/api/studentTimeTable/9/Tuesday");
